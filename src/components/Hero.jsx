...
const Hero = () => {
  return (
   ...
   <nav className="flex justify-between items-center w-full mb-10 pt-3">
    ...
    <button type="button" onClick={() => window.open('https://github.com/aditi75500')} className="black_btn"> Github </button>
   </nav>
   ...
   <h2 className="desc">  Simplify your reading with Summize, an article summarizer
