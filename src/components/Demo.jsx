...
//      <form className="relative flex jusitify-center items-center"
...
// {isFetching ? (
//     <img src={loader} alt="loader" className="w-20 h-20 onject-contain "/>
// ): error ? (
//     <p className="font-inter font-bold text-black text-center">Well, that wasnt happen <br /> 
